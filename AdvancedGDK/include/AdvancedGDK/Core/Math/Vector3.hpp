...
public:
	...
	constexpr bool nearlyEqual(Vector3<TVectorType2> const & other_, TEqualityType const equalityTolerance_) // Internal compiler error // = constants::LowTolerance<TEqualityType>) const
	{
		return (
